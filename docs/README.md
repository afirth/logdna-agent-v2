...
|`LOGDNA_LOG_REPORTER_METRICS`|Determines whether or not enable metrics usage statistics|`never`|
...
With This enabled the agent will pull from kubernetes metrics-server, process the usage statistics and display them with log lines in the web app. 
